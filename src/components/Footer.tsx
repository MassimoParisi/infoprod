...
const PartyPopperIcon = (props: React.ComponentPropsWithoutRef<"svg">) => {
  return (
    <svg viewBox="0 0 20 20" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
...
const SocialLink = ({
  ...
  return (
    <a href={href} target="_blank" rel="noreferrer" className="group">
      ...
      <Icon className="h-5 w-5 stroke-zinc-700 transition group-hover:stroke-gray-200" />
    </a>
  );
};
  ...
  return (
    <div className="mt-8 flex w-full flex-col items-center justify-between gap-5 border-t border-white/5 p-4 sm:flex-row">
      ...
      <div className="flex gap-4">
        <SocialLink href="https://www.massimo.pw/" icon={PartyPopper}>
          Personal Website
        </SocialLink>
        <SocialLink href="https://twitter.com/massimopa_dev" icon={XIcon}>
          Follow me on X
        </SocialLink>
        <SocialLink href="https://github.com/MassimoParisi" icon={GitHubIcon}>
          Follow me on GitHub
        </SocialLink>
      </div>
    </div>
